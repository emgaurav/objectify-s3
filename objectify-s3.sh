...
rm ~/.objectify/allbuckets.txt 2>/dev/null; touch ~/.objectify/allbuckets.txt 2>/dev/null
...
rm ~/.objectify/vulnbuckets.txt 2>/dev/null; touch ~/.objectify/vulnbuckets.txt 2>/dev/null;
